...
{
  wp_enqueue_style('er-pagadito-gateway', plugin_dir_url(__FILE__) . 'css/pagadito-gateway-admin.css', array(), '2.0.4', 'all');
  ...
  wp_enqueue_style("jquery.notyfy", plugin_dir_url(__FILE__) . 'css/jquery.notyfy.css', array(), '2.0.4', 'all');
  wp_enqueue_style("jquery.notyfy-themes", plugin_dir_url(__FILE__) . 'css/jquery.notyfy-themes.default.css', array(), '2.0.4', 'all');
  ...
  wp_enqueue_script("jquery.notyfy", plugin_dir_url(__FILE__) . 'js/jquery.notyfy.js', array('jquery-min'), '2.0.4', false);
  ...
  wp_enqueue_script('er-pagadito-gateway', plugin_dir_url(__FILE__) . 'js/pagatido-gateway-admin.js', array('jquery'), '2.0.4', false);
