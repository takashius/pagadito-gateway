...
final class WC_Er_Pagadito_Gateway_Blocks_Support extends AbstractPaymentMethodType
{

  private $gateway;

  protected $name = 'er_pagadito'; // payment gateway id
  ...
  public function get_payment_method_script_handles()
  {
    ...
    wp_register_script(
      'wc-er-pagadito-blocks-integration',
    ...
    return array('wc-er-pagadito-blocks-integration');
  }
